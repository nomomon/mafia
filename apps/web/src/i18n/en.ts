export const en = {
  ...
  home: {
    ...
    roomListHeading: "Open rooms",
    roomListEmpty: "No open rooms right now — start one above.",
    roomListEntry: "{host}'s room ({count} joined)",
  },
  ...
  role: {
    ...
    bakerDesc: "Each night, invite one player over for tea — whatever they were about to do that night quietly doesn't happen.",
  ...
  night: {
    ...
    bakerPrompt: "Choose a player to invite over for tea:",
    ...
    sheriffResultDistracted: "You got distracted having tea with the baker and couldn't finish investigating {name} last night.",
